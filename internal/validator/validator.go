...
// AddError adds an error message to the map so long as no message already exists for the given key.
...
// Matches returns true if a string value matches a regex pattern.
