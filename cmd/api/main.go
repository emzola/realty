...
func main() {
	...
	flag.StringVar(&cfg.db.dsn, "db-dsn", os.Getenv("REALTY_DB_DSN"), "PostgreSQL DSN")

	flag.IntVar(&cfg.db.maxOpenConns, "db-max-open-conns", 25, "PostgresQl max open connections")
	flag.IntVar(&cfg.db.maxIdleConns, "db-max-idle-conns", 25, "PostgresQl max idle connections")
	flag.StringVar(&cfg.db.maxIdleTime, "db-dsn", "15m", "PostgreSQL max connection idle time")
	flag.Parse()
